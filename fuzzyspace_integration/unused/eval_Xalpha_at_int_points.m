function rhos = eval_Xalpha_at_int_points(int_points, atom_xyz, nbf, bf_coef, bf_alpha, bf_exp, bf_centers, bf_nprim, DenMat)
    ...
    for iatom = 1 : ncenters
        ...
        for mu = 1 : nbf
        for nu = 1 : nbf
            rhos{iatom,mu,nu} = rhos{iatom,mu,nu} .* rho0;
        end
        end
    end
end